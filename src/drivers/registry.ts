...
export const DEVICE_DRIVERS: readonly DeviceDriver[] = [
  ...
  { brand: "Redragon", supports: (device) => RedragonM612HidClient.isSupported(device), create: (device) => new RedragonM612HidClient(device), score: () => 5 },
];
